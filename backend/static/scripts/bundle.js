  ...
  var t = {
      ...
      258: (t) => {
        t.exports = {
          ...
          GAME_UPDATED: function (t) {
            return "game:".concat(t, ":updated");
          },
        };
      },
    },
  ...
  (s.n = (t) => {
    ...
    (() => {
        ...
        U = {
          websocket: class extends w {
            ...
            doOpen() {
              ...
              try {
                this.ws = V ? new F(t, e, s) : e ? new F(t, e) : new F(t);
              } catch (t) {
      ...
      function nt(t, e) {
        ...
        if (Array.isArray(t))
          for (let s = 0; s < t.length; s++) t[s] = nt(t[s], e);
      ...
      !(function (t) {
        t.on(bt.GAME_CREATED, function (t) {
          ...
          t.created_at,
            vt.appendChild(
              (function (t, e) {
                var s = _t.content.cloneNode(!0);
                return (
                  s
                    .querySelector("a")
                    .setAttribute("href", "/api/games/".concat(t, "/join")),
                  (s.querySelector("span").innerText = t),
                  s
                );
              })(e)
            );
        ...
        (function (t, e) {
          t.on((0, bt.GAME_UPDATED)(e), function (t) {
            console.log({ game_state: t });
          });
        })(kt, wt);
      var Et = document.querySelector("#messages");
      kt.on(mt().CHAT_MESSAGE_RECEIVED, function (t) {
        var e = t.username,
          s = t.message,
          n = t.timestamp,
